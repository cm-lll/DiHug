...
class AbstractDatasetInfos:
    ...
    def compute_input_dims(self, datamodule, extra_features, domain_features):
        ...
        # NOTE: Do not densify the example graph here.
        # For single-graph large datasets (e.g. DBLP), converting edges to a dense 4D adjacency
        # is O(N^2) memory and can OOM at startup. Input dims can be inferred directly from
        # one-hot shapes below, and ExtraFeatures/DomainFeatures can densify internally if needed.
